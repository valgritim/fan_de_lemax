...
import { MagnifierService } from 'src/app/shared/magnifier.service';
...
export class ArticleDetailComponent implements OnInit {
  ...
  constructor(private router: Router, private magnifierService: MagnifierService, private articleService: ArticleService, private route: ActivatedRoute, private spinnerService: NgxSpinnerService, private requestsService : RequestsService, private modalService: NgbModal) { }
    ...
    this.route.params.subscribe(
      (params: Params) => {
        ...
        .subscribe(prices => {
          ...
          this.magnifierService.magnify("myimage", 2);
        });
